...
const PrivacyPolicyScreen = ({navigation}) => {
    ...
    const fetchContent = async () => {
      try {
        ...
        const response = await fetch(
          `${config.API_BASE_URL}/legals?key=privacy`,
        );
  ...
  const renderFormattedContent = text => {
    ...
    return paragraphs.map((paragraph, index) => {
      ...
      return (
        <CText key={index} style={styles.policyText}>
          {paragraph}
        </CText>
      );
    });
  ...
  return (
    <CView style={styles.container}>
      <CView row style={styles.titleContainer}>
        ...
        <CText style={styles.title}>Privacy Policy</CText>
      </CView>
      ...
      <ScrollView contentContainerStyle={styles.contentContainer}>
        {loading ? (
          ...
          <>
            {/* <CText style={styles.sectionHeading}>Privacy Policy</CText> */}
